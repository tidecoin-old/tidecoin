...
1. Clone the Tidecoin Core source code:

        git clone https://github.com/tidecoin-project/tidecoin
        cd tidecoin

2.  Build Tidecoin Core:

    Configure and build the headless Tidecoin Core binaries as well as the GUI (if Qt is found).
...
5.  Installation into user directories (optional):
    ...
    or
        ...
        cd ~/tidecoin/src
        cp tidecoind /usr/local/bin/
        cp tidecoin-cli /usr/local/bin/
...
Tidecoin Core is now available at `./src/tidecoind`
...
The first time you run tidecoind, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
...
-------
    ...
    ./src/tidecoind -daemon # Starts the tidecoin daemon.
    ./src/tidecoin-cli --help # Outputs a list of command-line options.
    ./src/tidecoin-cli help # Outputs a list of RPC commands when the daemon is running.
