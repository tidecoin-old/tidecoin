# Support for Output Descriptors in Tidecoin Core

Since Tidecoin Core v0.17, there is support for Output Descriptors. This is a
...
on Tidecoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Tidecoin Core wallets, a convenience function `combo` is
