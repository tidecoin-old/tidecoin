Tidecoin Core version *0.15.1* is now available from:

  <https://download.tidecoin.org/tidecoin-0.15.1/>
...
A number of changes to the way Tidecoin Core deals with peer connections and invalid blocks
