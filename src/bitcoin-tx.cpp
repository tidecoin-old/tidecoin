...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " tidecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  tidecoin-tx [options] <hex-tx> [commands]  Update hex-encoded tidecoin transaction\n" +
            "or:     tidecoin-tx [options] -create [commands]   Create hex-encoded tidecoin transaction\n" +
            "\n";
