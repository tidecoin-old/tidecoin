...
const char* BIP71_MIMETYPE_PAYMENT = "application/tidecoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/tidecoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/tidecoin-paymentrequest";
#endif
