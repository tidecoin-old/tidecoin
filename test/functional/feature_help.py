...
"""Verify that starting tidecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start tidecoin with -h for help text")
        ...
        self.log.info("Start tidecoin with -version for version information")
        ...
        self.log.info("Start tidecoind with -fakearg to make sure it does not start")
